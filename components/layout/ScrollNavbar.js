          ...
          <div className="lg:flex sm:text-xs md:text-sm hidden">
            <ul className="flex justify-items-between gap-10 hover:cursor-pointer">
              <Link href="/#diensten">
                ...
                >
                  <a href="/#diensten" className="my-auto">Diensten</a>
                  {showDiensten && (
                        ...
                        <div className="flex max-w-6xl mx-auto uppercase text-brown-pale justify-end h-full">
                          <ul className="flex flex-col justify-items-center text-left">
                            <Link href="/portretfotografie">
                              ...
                              >
                                <div className="h-full bg-white bg-opacity-90 pt-1 lg:pt-2 shadow-sm hover:underline hover:cursor-pointer">
                                  <a href="/portretfotografie" className="text-xxs lg:text-xs pl-4">
                                    Portret
                                  </a>
                                </div>
                              </li>
                            ...
                            <Link href="/loveshoot">
                              ...
                              >
                                <div className="h-full bg-white bg-opacity-90 pt-1 lg:pt-2 shadow-sm hover:underline hover:cursor-pointer">
                                  <a href="/loveshoot" className="text-xxs lg:text-xs pl-4">
                                    Loveshoot
                                  </a>
                                </div>
                              </li>
                            ...
                            <Link href="/zwangerschapsfotografie">
                              ...
                              >
                                <div className="h-full bg-white bg-opacity-90 pt-1 lg:pt-2 shadow-sm hover:underline hover:cursor-pointer">
                                  <a href="/zwangerschapsfotografie" className="text-xxs lg:text-xs pl-4">
                                    Zwangerschap
                                  </a>
                                </div>
                              </li>
                            ...
                            <Link href="/hondenfotografie">
                              ...
                              >
                                <div className="h-full bg-white bg-opacity-90 pt-1 lg:pt-2 shadow-sm hover:underline hover:cursor-pointer">
                                  <a href="/hondenfotografie" className="text-xxs lg:text-xs pl-4">
                                    Honden
                                  </a>
                                </div>
                              </li>
                            ...
                            <Link href="/fotobewerking-service">
                              ...
                              >
                                <div className="h-full pr-4 bg-white bg-opacity-90 pt-1 lg:pt-2 shadow-sm hover:underline hover:cursor-pointer">
                                  <a href="/fotobewerking-service" className="text-xxs lg:text-xs pl-4">
                                    Fotobewerking
                                  </a>
                                </div>
                              </li>
              ...
              <Link href="/fotoshoot-cadeaubon">
                <li className="text-center hover:underline flex flex-col justify-items-center">
                  <a href="/fotoshoot-cadeaubon" className="my-auto">Cadeaubon</a>
                </li>
              </Link>
              <Link href="/over-mij">
                <li className="text-center hover:underline flex flex-col justify-items-center">
                  <a href="/over-mij" className="my-auto">Over mij</a>
                </li>
              </Link>
              <Link href="/over-mij#contact">
                <li className="text-center hover:underline flex flex-col justify-items-center">
                  <a href="/over-mij#contact" className="my-auto">Contact</a>
                </li>
              </Link>
            </ul>
          </div>
