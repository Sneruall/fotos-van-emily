            ...
            <div>
              ...
              <div className="bg-white md:bg-opacity-0 py-20 md:py-0">
                ...
                <p className="font-sans normal-case text-black text-center md:text-left text-lg mx-6 md:mx-0 mt-7">
                  Ik woon in Zeist maar ben in heel Nederland actief, met mijn
                  tiny house opwielen kom ik overal naar toe! Je kunt bij mij
                  terecht voor een professionele fotoshoot voor allerlei
                  gelegenheden; van bruiloften tot hondenshoots. Met veel
                  aandacht en enthousiasme zorg ik voor prachtige foto’s waar
                  jij voor altijd van kan blijven genieten. Kijk rond op mijn
                  site en aarzel niet om contact met mij op te nemen!
                </p>
              </div>
            </div>
          </div>
